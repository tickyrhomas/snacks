  ...
  render() {
    return (
      <Container>
        ...
        <Card2 focus src='ricky_snack.png'>
...
class Card extends Component {
  ...
  render() {
    return (
      <CardStyle>
      {this.props.src?<CardImage src={this.props.src}/>:null}
